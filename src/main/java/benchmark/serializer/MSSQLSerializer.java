...
public class MSSQLSerializer implements Serializer {
	...
	public MSSQLSerializer(String directory, boolean forwardChaining, String database) {
...
//		 	dc:publisher
	...
	private class SQLTables {
		...
		private String createTable(String database, String tableName, String tableDefinition) {
			...
			sb.append("IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = N'" + database + "')\n");
			sb.append("BEGIN\n");
			sb.append("  CREATE DATABASE [" + database + "]\n");
			sb.append("END\n");
			sb.append("GO\n\n");
		...
		private String initProducer() {
			String tableDefinition = "  [nr] int primary key,\n" +
						"  [label] nvarchar(100) default NULL,\n" +
						"  [comment] nvarchar(2000) default NULL,\n" +
						"  [homepage] nvarchar(100) default NULL,\n" +
		...
		private String initProduct() {
			String tableDefinition = "  [nr] int primary key,\n" +
						...
						"  [propertyTex1] nvarchar(250) default NULL,\n" +
						"  [propertyTex2] nvarchar(250) default NULL,\n" +
						"  [propertyTex3] nvarchar(250) default NULL,\n" +
						"  [propertyTex4] nvarchar(250) default NULL,\n" +
						"  [propertyTex5] nvarchar(250) default NULL,\n" +
						"  [propertyTex6] nvarchar(250) default NULL,\n" +
